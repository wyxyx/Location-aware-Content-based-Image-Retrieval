	...
	<div class="container">
		<div class="row">
			...
			<form method="post" action="/searchImage"
				...
				<input id="shapeType" name="shapeType" type="text" style="display: none" value="0">
				<input id="p1Lng" name="p1Lng" type="text" style="display: none" value="50">
				<input id="p1Lat" name="p1Lat" type="text" style="display: none" value="50">
				<input id="p2Lng" name="p2Lng" type="text" style="display: none" value="60">
				<input id="p2Lat" name="p2Lat" type="text" style="display: none" value="60">
				
				<div class="input-group" style="z-index: 0;">
					<input name="searchStr" type="text" class="form-control"
						placeholder=""> <input name="lng" id="lngText" type="text"
						value="0" style="display: none" /> <input name="lat" id="latText"
